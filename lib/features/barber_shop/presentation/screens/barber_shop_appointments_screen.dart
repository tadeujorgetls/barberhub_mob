...
/// Tela de Agenda da Barbearia — placeholder (Prompt 2+).
class BarberShopAppointmentsScreen extends ConsumerWidget {
  const BarberShopAppointmentsScreen({super.key});
  @override
  Widget build(BuildContext context, WidgetRef ref) => const _PlaceholderScreen(
      icon: Icons.calendar_today_rounded, title: 'Agenda Completa');
}
